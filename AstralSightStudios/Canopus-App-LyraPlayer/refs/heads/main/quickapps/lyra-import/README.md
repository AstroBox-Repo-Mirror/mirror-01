...
└── tracks/<transaction-id>/
    ...
    ├── background.bin            # 可选，336×520（10 Pro）或 212×520（Band 11）LVGL v9 ARGB8888（底部 40px 透明渐隐）
...
- 单次事务：1 个 MP3，可附带 1 张 180×180 BIN 封面、1 张 336×520 或 212×520 BIN 播放页背景和 1 份歌词
- 快应用 hello 声明 `background`、`maxAssets:4`、`imageFormats:["lvgl-v9-argb8888-bin"]` 和 `backgroundWidths:[336,212]`；旧插件发送的 JPG/PNG 封面仍兼容
